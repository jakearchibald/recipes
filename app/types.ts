export const INGREDIENTS = [
  ...
  { name: 'Cucumber', unit: null },
  { name: 'Celery', unit: 'stalk' },
  { name: 'Broccoli', unit: 'g' },
  { name: 'Garden peas', unit: 'g' },
  ...
  { name: 'Hoisin sauce', unit: 'tbsp' },
  { name: 'Soy sauce', unit: 'tsp' },
  { name: 'Soy sauce', unit: 'tbsp' },
  { name: 'Dark soy sauce', unit: 'tbsp' },
  { name: 'Rice vinegar', unit: 'tsp' },
  { name: 'Rice vinegar', unit: 'tbsp' },
  { name: 'Thai red curry paste', unit: 'g' },
  { name: 'Red curry paste', unit: 'g' },
  { name: 'Fresh ginger', unit: 'tsp' },
  { name: 'Ginger paste', unit: 'tsp' },
  { name: 'Garlic paste', unit: 'tsp' },
  { name: 'Ground ginger', unit: 'tsp' },
  ...
  { name: 'Smooth orange juice', unit: 'tbsp' },
  { name: 'Eggs', unit: null },
